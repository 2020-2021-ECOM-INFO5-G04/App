...
@Component({
  selector: 'jhi-etudiant-affect-material',
  templateUrl: './etudiant-affect-material.component.html',
})
export class EtudiantAffectMaterialComponent implements OnInit {
