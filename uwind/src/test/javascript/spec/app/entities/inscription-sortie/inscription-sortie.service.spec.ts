...
describe('Service Tests', () => {
  describe('InscriptionSortie Service', () => {
    ...
    let elemDefault: IInscriptionSortie;
    let expectedResult: IInscriptionSortie | IInscriptionSortie[] | boolean | null;
    ...
    describe('Service methods', () => {
      ...
      it('should create a InscriptionSortie', () => {
        ...
        service.create(new InscriptionSortie()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should update a InscriptionSortie', () => {
        const returnedFromService = Object.assign({}, elemDefault);
      ...
      it('should return a list of InscriptionSortie', () => {
        const returnedFromService = Object.assign({}, elemDefault);
      ...
      it('should delete a InscriptionSortie', () => {
